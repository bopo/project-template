...
from .charts import machine_usage_chart, member_registration_chart


class RandomCurveWidget(Widget):
    name = 'Random Curve Widget'
    html_id = 'random_curve_widget'
    template = 'dashboard/random_curve.html'
...
class MachineInfoWidget(Widget):
    ...
    @property
    def content(self):
        l = '1122432.51 1107218.60'
        s = timedelta(seconds=float(l.split()[0])).total_seconds()  # NOQA
...
class MachineUsageWidget(Widget):
    ...
    template = 'dashboard/machine_usage.html'
