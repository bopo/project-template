...
from .serializers import PasswordChangeSerializer as DefaultPasswordChangeSerializer
from .serializers import PasswordResetConfirmSerializer as DefaultPasswordResetConfirmSerializer
from .serializers import PasswordResetSerializer as DefaultPasswordResetSerializer
