...
from .contrib.core.backends.utils import user_backends_data
from .utils import BACKENDS, Storage
...
def backends(request):
    ...
    Will return the output of .contrib.core.backends.utils.user_backends_data."""
