...
from .models import DBImgTextMsg, DBTextMsg, PatternE2PT, PatternE2T, PatternT2PT, PatternT2T, WechatMember, WechatMenu
...
admin.site.register(WechatMember, MemberAdmin)
